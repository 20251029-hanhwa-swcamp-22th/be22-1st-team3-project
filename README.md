...
# 프로젝트 회고
> - 조민규 : 
> - 정현호 : 처음에는 구현만 어려울 줄 알았습니다. 하지만, 구현이 아닌 프로젝트를 진행하며 서로의 생각을 규합하는 과정이 굉장히 어렵다는 것을 깨달았습니다. 이를 통해 협업시 설계 과정에서 더 오랜 시간을 쏟는 다는 말을 한층 더 깊이 이해할 수 있게 되었습니다. 또한, 설계 과정시 최대한 긴 시간을 할애해야 구현 과정에서의 논리적 오류 해결을 최소화 시킬 수 있다는 것을 알았습니다. 다들 고생 많았던 것 같습니다.
> - 김선일 : SW공학, 데이터베이스, 리눅스를 학습하고 처음으로 프로젝트를해서 부족한것도 많았지만 다음에는 잘 할수 있도록 노력해야겠다.
> - 최현지 : 프로젝트를 시작하면서 프로젝트 기획, 요구사항 명세서, 유스케이스 다이어그램, DB 설계, 구현하는 것까지 쉽지 않은 일이었지만 팀원분들과 같이 하면서 DB 구조에 대해서 전반적으로 이해하는 과정이었고 소통과 협업의 중요성을 깨닫게 되었습니다.
